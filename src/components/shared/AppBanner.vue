...
<template>
	...
	>
		...
		<div class="w-full md:w-1/3 text-left">
			...
			>
				A DevOps Engineer & SRE Anthusiast
			</p>
			<div class="flex justify-center sm:block">
				<a
					download="Agung-Resume.pdf"
					href="/files/Agung's-Resume.pdf"
		...
		<div class="w-full md:w-2/3 text-right float-right">
			<img
				v-if="theme === 'light'"
				src="https://storage.googleapis.com/dicodingku/banner.svg"
				alt="Developer"
			/>
			<img
				v-else
				src="https://storage.googleapis.com/dicodingku/banner-dark.svg"
				alt="Developer"
			/>
		</div>
	</section>
